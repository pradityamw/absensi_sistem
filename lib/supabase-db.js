...
export const SupabaseDb = {
    ...
    async login(email, password) {
        ...
        if (!this.client) {
            return { success: false, message: "Gagal masuk: Database Supabase tidak terhubung. Silakan periksa kredensial di halaman Pengaturan.", user: null };
        }
    ...
    async getUsers() {
        if (!this.client) throw new Error("Database Supabase tidak terhubung. Silakan periksa kredensial di halaman Pengaturan.");
